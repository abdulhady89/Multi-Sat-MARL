...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mappo', choices=["ippo", "rmappo", "mappo", "happo", "c_ppo"])
    # parser.add_argument('--scenario_name', type=str,
    #                     default='default', choices=["ideal", "default", "limited", "random", "hetero_batt", "hetero_mem"])
    parser.add_argument('--scenario_name', type=str,
                        default='default')
    ...
    parser.add_argument("--cuda_deterministic",
                        type=bool, default=True, help="by default, make sure random seed effective. if set, bypass such function.")
    ...
    parser.add_argument("--env_name", type=str, default='BSK',
                        help="specify the name of environment")
    parser.add_argument("--use_obs_instead_of_state", action='store_true',
                        default=False, help="Whether to use global state or concatenated obs")
    parser.add_argument("--constellation_type", type=str,
                        default="Cluster", choices=["Cluster", "Walker"])
    ...
    parser.add_argument("--memory_size", type=int, default=5e5,
                        help="Memory size of the satellite (500 Gbyte).")
    parser.add_argument("--baud_rate", type=float, default=4.3,
                        help='control baud rate of sattellite transmitter (kbps)')
    ...
    parser.add_argument("--n_act_image", type=int, default=4,
                        help="Number of action images.")
    parser.add_argument("--n_obs_image", type=int, default=4,
    ...
    parser.add_argument("--use_ReLU", type=bool,
    ...
    parser.add_argument("--diversity_coef", type=float, default=0.0,
                        help="coeficient of diversity regularization")
