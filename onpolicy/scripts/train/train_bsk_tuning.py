...
def parse_args(args, parser):
    ...
    parser.add_argument("--uniform_targets", type=int,
                        default=1000, help="Number of uniform targets.")
    ...
    parser.add_argument("--instr_baud_rate", type=int, default=1000,
...
def main(args):
    ...
    run_dir = Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[
                   0] + "/results/tune")/all_args.scenario_name/all_args.experiment_name
    ...
    if all_args.use_wandb:
        ...
        curr_run = (f'run_tuning_seed{all_args.seed}'
                    f'_epoch{all_args.ppo_epoch}'
                    f'_clip{all_args.clip_param}'
                    f'_gain{all_args.gain}'
    ...
    setproctitle.setproctitle(str(all_args.algorithm_name) + "-" +
                              str(all_args.experiment_name) + "-" + str(all_args.constellation_type))
