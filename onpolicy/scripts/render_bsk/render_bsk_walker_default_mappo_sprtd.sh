...
constellation="Walker" #"Cluster" or "Walker"
num_agents=4
...
do
    ...
    --model_dir "/home/maxsum/wshdymarl/on-policy/onpolicy/scripts/results_fix/Walker/default/mappo/run_walk_sat4_tgt2000_batt400_mem500000.0_baud4.3_seed1_2025-02-09_07-59-06_8136/models"
done